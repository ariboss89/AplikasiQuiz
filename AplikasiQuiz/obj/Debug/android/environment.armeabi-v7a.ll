...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	; 6
	%struct.DSOCacheEntry {
		i64 757553115, ; hash 0x2d2757db, from name: PDFNetC.so
		i8 0, ; ignore
	...
	; 12
	%struct.DSOCacheEntry {
		i64 1861025016, ; hash 0x6eecfcf8, from name: libPDFNetC.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 18
	%struct.DSOCacheEntry {
		i64 2802715259, ; hash 0xa70e0a7b, from name: PDFNetC
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 21
	%struct.DSOCacheEntry {
		i64 2983146880, ; hash 0xb1cf3580, from name: libPDFNetC
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
