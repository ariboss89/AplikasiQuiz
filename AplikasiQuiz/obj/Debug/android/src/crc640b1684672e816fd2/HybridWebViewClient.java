...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AplikasiQuiz.Activities.HybridWebViewClient, AplikasiQuiz", HybridWebViewClient.class, __md_methods);
	}
	...
	public HybridWebViewClient ()
	{
		...
		if (getClass () == HybridWebViewClient.class) {
			mono.android.TypeManager.Activate ("AplikasiQuiz.Activities.HybridWebViewClient, AplikasiQuiz", "", this, new java.lang.Object[] {  });
		}
	}
