...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"80691b57-5284-4145-b4b0-72158e5c4d0b\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [27 x i8] c"com.ari89tech.aplikasiquiz\00", align 16
...
@__DSOCacheEntry_name.5 = internal constant [14 x i8] c"libPDFNetC.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	; 8
	%struct.DSOCacheEntry {
		i64 7078700497610264637, ; hash 0x623c98991770d03d, from name: libPDFNetC.so
		i8 0, ; ignore
	...
	; 24
	%struct.DSOCacheEntry {
		i64 15651714209951900118, ; hash 0xd9360f25ca1de1d6, from name: PDFNetC
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 25
	%struct.DSOCacheEntry {
		i64 16099298692298306476, ; hash 0xdf6c32dce759f3ac, from name: libPDFNetC
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 31
	%struct.DSOCacheEntry {
		i64 18380346319401666215, ; hash 0xff141b98209846a7, from name: PDFNetC.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}
